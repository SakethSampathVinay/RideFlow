...
type City = "New York" | "Los Angeles" | "Houston" | "Chicago";
...
type CarCategory = "SUV" | "Sedan";
type FuelType = "Hybrid" | "Diesel" | "Petrol";
type Transmission = "Semi-Automatic" | "Manual" | "Automatic";
...
interface OwnerMenuLink extends MenuLink {
  icon: string;
  coloredIcon: string;
}
...
export const dummyTestimonialData = [
  {
    ...
    text: "Great service! The car was in excellent condition and the staff was very helpful.",
  },
  {
    _id: "2",
    name: "Jane Smith",
    ...
    text: "I had a wonderful experience renting a car from this company. Highly recommend!",
  },
  {
    _id: "3",
    name: "Janes",
